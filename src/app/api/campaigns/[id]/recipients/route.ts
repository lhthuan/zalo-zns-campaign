...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const selectClause = filterName
      ? "id, phone, zalo_uid, import_batch, send_mode, status, zalo_msg_id, error_code, error_message, template_data, sent_at, created_at, customers!inner(name)"
      : "id, phone, zalo_uid, import_batch, send_mode, status, zalo_msg_id, error_code, error_message, template_data, sent_at, created_at, customers(name)";
